...
enum DiarizerModelStore {
    ...
    /// to the Hugging Face uploads (sizes checked 2026-07-05).
    static let files: [ModelRemoteFile] = [
        ModelRemoteFile(
    ...
    /// Download any missing files (skip-completed doubles as resume) with
    /// size-weighted progress — the shared manifest loop.
