...
/// (SenseVoice + speaker model + Qwen3.5 2B) comes pre-checked, Qwen3-ASR
/// is an unchecked extra, and Apple speech assets are locked on as the
/// fallback engine. Skipping is always allowed — Settings offers everything
/// later.
        ...
        ScrollView {
            VStack(spacing: 24) {
                VStack(spacing: 8) {
                    ...
                    Text("Everything runs on this iPhone. The recommended set gives you accurate live captions, speaker separation and AI summaries.")
                        .font(.footnote)
